...
Jednym z głównych powodów wyboru Proxmox VE jest natywna obsługa **konteneryzacji LXC**. Rozwiązanie to sprawdza się idealnie w przypadku uruchamiania pojedynczych aplikacji lub lekkich usług, gdzie nie ma potrzeby tworzenia pełnych maszyn wirtualnych. Kontenery charakteryzują się mniejszym narzutem na zasoby oraz szybszym czasem uruchamiania. Takie podejście zostało zastosowane m.in. przy budowie systemu **PACS** oraz integracji pomiędzy innymi systemami. [Zostało to opisane tutaj.](/lxc)
